...
class LayerMathMixin:
    ...
    def _eval(self, area, index, step, target_window=None):
        try:
            ...
            return self._read_array_for_area(area, 0, index, window.xsize, step, False)
        except AttributeError:
            return self._read_array_for_area(area, 0, index, target_window.xsize if target_window else 1, step, False)
