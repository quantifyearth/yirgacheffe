...
@pytest.mark.parametrize(
    ...
    [
        (
            Area(-10, 10, 10, -10, MapProjection("epsg:4326", 0.2, -0.2)),
            (0, 0),
            (10.0, -10.0)
        ),
        (
        ...
        (
            Area(10, 10, 20, -10, MapProjection("epsg:4326", 0.2, -0.2)),
            (1, 1),
            (9.8, 10.2)
        ),
        (
            Area(-10, -10, 10, -20, MapProjection("epsg:4326", 0.2, -0.2)),
            (1, 1),
            (-10.2, -9.8)
        ),
    ]
...
def test_latlng_for_pixel_on_operator() -> None:
    ...
    with (
        ...
        assert layer1.area == Area(-10, 10, 10, -10, MapProjection("epsg:4326", 1.0, -1.0))
        assert layer2.area == Area(-10, 10, 10, -10, MapProjection("epsg:4326", 1.0, -1.0))
...
@pytest.mark.parametrize(
    ...
    [
        (
            Area(-10, 10, 10, -10, MapProjection("epsg:4326", 0.2, -0.2)),
            Area(-5, 5, 5, -5, MapProjection("epsg:4326", 0.2, -0.2)),
            (0, 0),
            (5.0, -5.0)
        ),
        (
        ...
        (
            Area(10, 10, 20, -10, MapProjection("epsg:4326", 0.2, -0.2)),
            Area(15, 5, 20, -5, MapProjection("epsg:4326", 0.2, -0.2)),
            (1, 1),
            (4.8, 15.2)
        ),
        (
            Area(-10, -10, 10, -20, MapProjection("epsg:4326", 0.2, -0.2)),
            Area(-5, -15, 5, -20, MapProjection("epsg:4326", 0.2, -0.2)),
            (1, 1),
            (-15.2, -4.8)
        ),
    ]
