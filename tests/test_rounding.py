...
from yirgacheffe._datatypes.mapprojection import (
    MINIMAL_DEGREE_OF_INTEREST,
    MINIMAL_DISTANCE_OF_INTEREST_IN_M,
)
...
@pytest.mark.parametrize(
    ...
    [
        ...
        (
            ...
            MapProjection(
                "epsg:4326",
                0.1 + (MINIMAL_DEGREE_OF_INTEREST / 2),
                0.1 + (MINIMAL_DEGREE_OF_INTEREST / 2),
            ),
            True,
        ),
...
def test_pixel_scale_comparison(
    lhs: MapProjection, rhs: MapProjection, expected: bool
) -> None:
