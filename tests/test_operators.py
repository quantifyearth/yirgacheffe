...
from helpers import make_dataset_with_data
...
def test_add_byte_layers() -> None:
	...
	layer1 = Layer(make_dataset_with_data((0.0, 0.0), 0.02, data1))
	layer2 = Layer(make_dataset_with_data((0.0, 0.0), 0.02, data2))
